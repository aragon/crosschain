...
> governs the adapter, which is what the deploy kit grants and `assertDaoOwnsItsChainIdRegistry`
> pins. Monitoring that watches `chainToAdapter` will not see registry changes: watch
> `ChainIdPairSet` too.
